class Fase2 extends Phaser.Scene {
    create() {
        ...
        this.ground2.create(200, 300, 'ground2');
        this.ground2.create(300, 500, 'ground2');
        this.ground2.create(400, 320, 'ground2');
        this.ground2.create(600, 150, 'ground2');
        this.ground2.create(350, 120, 'ground2');
        this.ground2.create(680, 420, 'ground2');
        ...
        this.slimes.create(600, 120, 'slime');

        this.foods = this.physics.add.group();
        this.foods.create(300, 460, 'strawberryCake');
        this.foods.create(350, 80, 'pizza');
